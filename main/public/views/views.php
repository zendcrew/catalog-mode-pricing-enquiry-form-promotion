        ...
        private function get_shop_locations() {
            ...
            return array(
                'product_thumbnail' => array(
                    'show_in_admin' => false,
                    'title' => esc_html__( 'Product Thumbnail', 'zcwm-tdm' ),
                    'hook' => 'woocommerce_before_shop_loop_item_title',
                    'priority' => 11,
                ),
                'before_title' => array(
                    'show_in_admin' => true,
                    'title' => esc_html__( 'Before Loop Title', 'zcwm-tdm' ),
                    'hook' => 'woocommerce_shop_loop_item_title',
                    'priority' => 9,
                ),
                'after_title' => array(
                    'show_in_admin' => true,
                    'title' => esc_html__( 'After Loop Title', 'zcwm-tdm' ),
                    'hook' => 'woocommerce_after_shop_loop_item_title',
                    'priority' => 4,
                ),
                'after_rating' => array(
                    'show_in_admin' => true,
                    'title' => esc_html__( 'After Loop Rating', 'zcwm-tdm' ),
                    'hook' => 'woocommerce_after_shop_loop_item_title',
                    'priority' => 6,
                ),
                'after_price' => array(
                    'show_in_admin' => true,
                    'title' => esc_html__( 'After Loop Price', 'zcwm-tdm' ),
                    'hook' => 'woocommerce_after_shop_loop_item_title',
                    'priority' => 11,
                ),
                'after_add_to_cart' => array(
                    'show_in_admin' => true,
                    'title' => esc_html__( 'After Loop Add to Cart', 'zcwm-tdm' ),
        ...
        private function get_single_product_locations() {
            ...
            return array(
                ...
                'before_summary' => array(
                    'show_in_admin' => false,
                    'title' => esc_html__( 'Before Product Summary', 'zcwm-tdm' ),
                    'hook' => 'woocommerce_before_single_product_summary',
                    'priority' => 1,
                ),
                'before_title' => array(
                    'show_in_admin' => true,
                    'title' => esc_html__( 'Before Summary Title', 'zcwm-tdm' ),
                    'hook' => 'woocommerce_single_product_summary',
                    'priority' => 4,
                ),
                'after_title' => array(
                    'show_in_admin' => true,
                    'title' => esc_html__( 'After Summary Title', 'zcwm-tdm' ),
                    'hook' => 'woocommerce_single_product_summary',
                    'priority' => 6,
                ),
                'after_rating' => array(
                    'show_in_admin' => true,
                    'title' => esc_html__( 'After Summary Rating &amp; Price', 'zcwm-tdm' ),
                    'hook' => 'woocommerce_single_product_summary',
                    'priority' => 11,
                ),
                'after_excerpt' => array(
                    'show_in_admin' => true,
                    'title' => esc_html__( 'After Summary Excerpts', 'zcwm-tdm' ),
                    'hook' => 'woocommerce_single_product_summary',
                    'priority' => 21,
                ),
                'after_add_to_cart' => array(
                    'show_in_admin' => true,
                    'title' => esc_html__( 'After Summary Add to Cart', 'zcwm-tdm' ),
                    'hook' => 'woocommerce_single_product_summary',
                    'priority' => 31,
                ),
                'after_meta' => array(
                    'show_in_admin' => true,
                    'title' => esc_html__( 'After Summary Meta', 'zcwm-tdm' ),
                    'hook' => 'woocommerce_single_product_summary',
                    'priority' => 41,
                ),
                'after_share' => array(
                    'show_in_admin' => true,
                    'title' => esc_html__( 'After Summary Share', 'zcwm-tdm' ),
                    'hook' => 'woocommerce_single_product_summary',
                    'priority' => 51,
                ),
                'after_summary' => array(
                    'show_in_admin' => false,
                    'title' => esc_html__( 'After Product Summary', 'zcwm-tdm' ),
