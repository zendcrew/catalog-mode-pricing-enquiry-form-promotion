...
if ( !class_exists( 'WModes_Admin_Product_Option_Type_Sale_Flash' ) && !defined( 'WMODES_PREMIUM_ADDON' ) ) {
    ...
    class WModes_Admin_Product_Option_Type_Sale_Flash {
        ...
        public static function init() {
            ...
            add_filter( 'wmodes-admin/product-options/get-promotions-option-types', array( new self(), 'get_types' ), 160, 2 );

            add_filter( 'wmodes-admin/product-options/get-option-type-prem_20-fields', array( new self(), 'get_fields' ), 10, 2 );
        ...
        public static function get_types( $in_options, $args = array() ) {
            ...
            $in_options[ 'prem_20' ] = array(
                'title' => esc_html__( 'Hide Sale Flash (Premium)', 'zcwm-tdm' ),
            );
    ...
    WModes_Admin_Product_Option_Type_Sale_Flash::init();
}
