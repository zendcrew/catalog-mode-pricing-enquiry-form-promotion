    ...
    class WModes_Admin_Product_Option_Type_Stock {
        ...
        public static function get_types( $in_options, $args = array() ) {
            ...
            $in_options[ 'stock' ] = array(
                'title' => esc_html__( 'Stock Settings', 'zcwm-tdm' ),
            );
        ...
        public static function get_fields( $in_fields, $args ) {
            ...
            $in_fields[] = array(
                ...
                'columns' => 3,
                'merge_fields' => false,
                'fields' => self::get_second_panel_fields(),
            );
        ...
        private static function get_panel_fields() {
            ...
            $in_fields[] = array(
                ...
                'type' => 'select2',
                'column_size' => 1,
                'column_title' => esc_html__( 'Manage Stock', 'zcwm-tdm' ),
                'tooltip' => esc_html__( 'Enables stock management at product level', 'zcwm-tdm' ),
                'disabled_list_filter' => 'wmodes-admin/get-disabled-list',
                'default' => 'no',
                'options' => array(
                    'prem_1' => esc_html__( 'Yes (Premium)', 'zcwm-tdm' ),
                    'prem_2' => esc_html__( 'Yes (%) (Premium)', 'zcwm-tdm' ),
            ...
            $in_fields[] = array(
                ...
                'type' => 'select2',
                'column_size' => 3,
                'column_title' => esc_html__( 'Stock Status', 'zcwm-tdm' ),
                'tooltip' => esc_html__( 'Controls whether or not the product is listed as "in stock" or "out of stock" on the frontend', 'zcwm-tdm' ),
                'default' => 'instock',
            ...
            $in_fields[] = array(
                ...
                'type' => 'textblock',
                'column_size' => 1,
                'column_title' => esc_html__( 'Sold Individually', 'zcwm-tdm' ),
                'tooltip' => esc_html__( 'Enable this to only allow one of this item to be bought in a single order', 'zcwm-tdm' ),
                'show_box' => true,
        ...
        private static function get_second_panel_fields() {
            ...
            $in_fields[] = array(
                ...
                'type' => 'textblock',
                'column_size' => 2,
                'column_title' => esc_html__( 'Availability Text', 'zcwm-tdm' ),
                'tooltip' => esc_html__( 'Controls product availability text on the frontend', 'zcwm-tdm' ),
                'show_box' => true,
            ...
            $in_fields[] = array(
                ...
                'type' => 'textblock',
                'column_size' => 1,
                'column_title' => esc_html__( 'Is Featured', 'zcwm-tdm' ),
                'tooltip' => esc_html__( 'Sets product as featured product on the frontend', 'zcwm-tdm' ),
                'show_box' => true,
                'text' => WModes_Admin_Page::get_premium_messages( 'short' ),
                'width' => '100%',
            );
