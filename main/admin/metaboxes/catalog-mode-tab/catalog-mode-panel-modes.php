            ...
            $in_fields[] = array(
                ...
                'fields' => array(
                    array(
                        ...
                        'desc' => esc_html__( 'List of catalog modes settings to apply, empty list will not apply any catalog mode settings', 'catalog-mode-pricing-enquiry-forms-promotions' ),
                    )
                ),
            );
