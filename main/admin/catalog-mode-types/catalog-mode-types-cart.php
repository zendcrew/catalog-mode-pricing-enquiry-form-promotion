    ...
    class WModes_Admin_Catalog_Mode_Types_Cart {
        ...
        public static function get_types( $in_options, $args = array() ) {
            ...
            $in_options[ 'cart' ] = array(
                'title' => esc_html__( 'Cart Page Settings', 'zcwm-tdm' ),
            );
        ...
        private static function get_settings_fields( $args ) {
            ...
            $in_fields[] = array(
                ...
                'tooltip' => esc_html__( 'Restricts access to "Cart" page and disable all cart functions', 'zcwm-tdm' ),
                'default' => 'no',
                'options' => array(
            ...
            $in_fields[] = array(
                ...
                'tooltip' => esc_html__( 'Determines how the "Cart" page should be restricted', 'zcwm-tdm' ),
                'show_box' => true,
            ...
            $in_fields[] = array(
                ...
                'type' => 'textblock',
                'column_size' => 1,
                'column_title' => esc_html__( 'Remove Subtotals', 'zcwm-tdm' ),
                'tooltip' => esc_html__( 'Disables subtotals on "Cart" page', 'zcwm-tdm' ),
                'show_box' => true,
                'text' => WModes_Admin_Page::get_premium_messages( 'short' ),
                'width' => '100%',
                'fold' => array(
            ...
            $in_fields[] = array(
                ...
                'type' => 'textblock',
                'column_size' => 1,
                'column_title' => esc_html__( 'Remove Cross Sells', 'zcwm-tdm' ),
                'tooltip' => esc_html__( 'Disables "Cross Sells" products on "Cart" page', 'zcwm-tdm' ),
                'show_box' => true,
                'text' => WModes_Admin_Page::get_premium_messages( 'short' ),
                'width' => '100%',
                'fold' => array(
        ...
        private static function get_prices_fields( $args ) {
            ...
            $in_fields[] = array(
                ...
                'type' => 'select2',
                'column_size' => 1,
                'column_title' => esc_html__( 'Hide Product Prices', 'zcwm-tdm' ),
                'tooltip' => esc_html__( 'Hides product prices and totals on "Cart" page', 'zcwm-tdm' ),
                'default' => 'no',
                'disabled_list_filter' => 'wmodes-admin/get-disabled-list',
                'options' => array(
                    'prem_1' => esc_html__( 'Yes (Premium)', 'zcwm-tdm' ),
                    'prem_2' => esc_html__( 'Yes, hide product prices/totals columns (Premium)', 'zcwm-tdm' ),
                    'no' => esc_html__( 'No', 'zcwm-tdm' ),
                ),
                'width' => '100%',
            );
        ...
        private static function get_enquiry_button_fields( $args ) {
            ...
            $in_fields[] = array(
                ...
                'type' => 'textblock',
                'column_size' => 1,
                'column_title' => esc_html__( 'Remove Coupons', 'zcwm-tdm' ),
                'tooltip' => esc_html__( 'Disables coupons on "Cart" and "Checkout" pages', 'zcwm-tdm' ),
                'show_box' => true,
                'text' => WModes_Admin_Page::get_premium_messages( 'short' ),
                'width' => '100%',
                'fold' => array(
            ...
            $in_fields[] = array(
                ...
                'type' => 'select2',
                'column_size' => 1,
                'column_title' => esc_html__( 'Enable Cart Enquiry', 'zcwm-tdm' ),
                'tooltip' => esc_html__( 'Enables cart enquiry functions on "Cart" page', 'zcwm-tdm' ),
                'default' => 'no',
                'disabled_list_filter' => 'wmodes-admin/get-disabled-list',
                'options' => array(
                    'prem_1' => esc_html__( 'Yes (Premium)', 'zcwm-tdm' ),
