    ...
    class WModes_Admin_Catalog_Mode_Types_Product {
        ...
        private static function get_other_fields( $args ) {
            ...
            $in_fields[] = array(
                ...
                'type' => 'textblock',
                'column_size' => 1,
                'column_title' => esc_html__( 'Stars Rating Visibility', 'wmodes-tdm' ),
                'tooltip' => esc_html__( 'Controls stars rating visibility on product page', 'wmodes-tdm' ),
                'show_box' => true,
            ...
            $in_fields[] = array(
                ...
                'type' => 'textblock',
                'column_size' => 1,
                'column_title' => esc_html__( 'Product Tabs Visibility', 'wmodes-tdm' ),
                'tooltip' => esc_html__( 'Controls product tabs visibility on product page', 'wmodes-tdm' ),
                'show_box' => true,
                'text' => WModes_Admin_Page::get_premium_messages( 'short' ),
                'width' => '100%',
            );
