    ...
    class WModes_Admin_Catalog_Mode_Types_Shop {
        ...
        public static function get_fields( $in_fields, $args = array() ) {
            ...
            $in_fields[] = array(
                ...
                'center_head' => true,
                'merge_fields' => false,
                'title' => esc_html__( 'Stars Rating Settings', 'catalog-mode-pricing-enquiry-forms-promotions' ),
                'desc' => esc_html__( 'Use these settings to control stars rating on shop page', 'catalog-mode-pricing-enquiry-forms-promotions' ),
                'field_css_class' => array( 'wmodes_locations_title' ),
        ...
        private static function get_add_to_cart_fields( $args ) {
            ...
            $in_fields[] = array(
                ...
                'options' => array(
                    ...
                    'prem_1' => esc_html__( 'Label (Premium)', 'catalog-mode-pricing-enquiry-forms-promotions' ),
                    'prem_2' => esc_html__( 'Link Button (Premium)', 'catalog-mode-pricing-enquiry-forms-promotions' ),
            ...
            if ( $args[ 'is_global' ] ) {
                ...
                $in_fields[] = array(
                    ...
                    'type' => 'textblock',
                    'column_size' => 1,
                    'column_title' => esc_html__( 'Variable "Add to Cart" Text', 'catalog-mode-pricing-enquiry-forms-promotions' ),
                    'tooltip' => esc_html__( 'Controls "Add to Cart" text on variable products', 'catalog-mode-pricing-enquiry-forms-promotions' ),
                    'show_box' => true,
        ...
        private static function get_add_to_cart_url_fields( $args ) {
            ...
            $in_fields[] = array(
                ...
                'options' => array(
                    ...
                    'prem_1' => esc_html__( 'Blog post page link (Premium)', 'catalog-mode-pricing-enquiry-forms-promotions' ),
                    'prem_2' => esc_html__( 'Page link (Premium)', 'catalog-mode-pricing-enquiry-forms-promotions' ),
            ...
            $in_fields[] = array(
                ...
                'type' => 'textblock',
                'column_size' => 1,
                'column_title' => esc_html__( 'Target', 'catalog-mode-pricing-enquiry-forms-promotions' ),
                'tooltip' => esc_html__( 'Determines whether or not the link should open in a new browser tab', 'catalog-mode-pricing-enquiry-forms-promotions' ),
                'show_box' => true,
                'text' => WModes_Admin_Page::get_premium_messages( 'short' ),
                'width' => '100%',
                'fold' => array(
