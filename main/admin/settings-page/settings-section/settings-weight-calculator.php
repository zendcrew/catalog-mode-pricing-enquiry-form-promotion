...
if ( !class_exists( 'WModes_Admin_Weight_Calc_Settings' ) && !defined( 'WMODES_PREMIUM_ADDON' ) ) {

    class WModes_Admin_Weight_Calc_Settings {

        public static function init() {

            add_filter( 'wmodes-admin/get-settings-section-panels', array( new self(), 'get_panel' ), 20 );
        }
    ...
    WModes_Admin_Weight_Calc_Settings::init();
}
