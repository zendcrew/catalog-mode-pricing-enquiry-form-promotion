    ...
    class WModes_Admin_Settings_Styles_CountDown_Inline_Settings {
        ...
        private static function get_fields( $in_fields ) {
            ...
            $in_fields[] = array(
                ...
                'full_width' => true,
                'center_head' => true,
                'title' => esc_html__( 'Countdown - Style 1 Designs', 'catalog-mode-pricing-enquiry-forms-promotions' ),
                'desc' => esc_html__( 'Use these settings to create and manage countdown style 1 designs', 'catalog-mode-pricing-enquiry-forms-promotions' ),
            );
