    ...
    class WModes_Admin_Settings_Styles_Price_Details_Settings {
        ...
        private static function get_fields( $in_fields ) {
            ...
            $in_fields[] = array(
                ...
                'full_width' => true,
                'center_head' => true,
                'title' => esc_html__( 'Price Detail Designs', 'catalog-mode-pricing-enquiry-forms-promotions' ),
                'desc' => esc_html__( 'Use these settings to create and manage price detail designs', 'catalog-mode-pricing-enquiry-forms-promotions' ),
            );
