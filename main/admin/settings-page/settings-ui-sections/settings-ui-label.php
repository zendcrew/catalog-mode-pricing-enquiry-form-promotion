    ...
    class WModes_Admin_Settings_Styles_Label_Settings {
        ...
        private static function get_fields( $in_fields ) {
            ...
            $in_fields[] = array(
                ...
                'full_width' => true,
                'center_head' => true,
                'title' => esc_html__( 'Label List Designs', 'catalog-mode-pricing-enquiry-forms-promotions' ),
                'desc' => esc_html__( 'Use these settings to create and manage label list container designs', 'catalog-mode-pricing-enquiry-forms-promotions' ),
            );
        ...
        private static function design_fields( $in_fields ) {
            ...
            $in_fields[] = array(
                ...
                'options' => array(
                    ...
                    'prem_1' => esc_html__( 'Stacked (Premium)', 'catalog-mode-pricing-enquiry-forms-promotions' )
                ),
                'width' => '100%',
            );
        ...
        private static function design_two_fields( $in_fields ) {
            ...
            $in_fields[] = array(
                ...
                'type' => 'textblock',
                'column_width' => '180px',
                'column_title' => esc_html__( 'Icon / Text Gap', 'catalog-mode-pricing-enquiry-forms-promotions' ),
                'tooltip' => esc_html__( 'Controls the space between icon and text of the label', 'catalog-mode-pricing-enquiry-forms-promotions' ),
                'show_box' => true,
        ...
        private static function get_text_fields( $in_fields ) {
            ...
            $in_fields[] = array(
                ...
                'type' => 'textblock',
                'column_no_size' => true,
                'column_title' => esc_html__( 'Text Format', 'catalog-mode-pricing-enquiry-forms-promotions' ),
                'tooltip' => esc_html__( 'Determines the prefix and suffix text of the label on products', 'catalog-mode-pricing-enquiry-forms-promotions' ),
                'show_box' => true,
                'text' => WModes_Admin_Page::get_premium_messages( 'short' ),
                'width' => '100%',
            );
            ...
            $in_fields[] = array(
                ...
                'type' => 'textblock',
                'column_no_size' => true,
                'column_title' => esc_html__( 'Variation Text Format', 'catalog-mode-pricing-enquiry-forms-promotions' ),
                'tooltip' => esc_html__( 'Determines the prefix and suffix text of the label on variable products', 'catalog-mode-pricing-enquiry-forms-promotions' ),
                'show_box' => true,
                'text' => WModes_Admin_Page::get_premium_messages( 'short' ),
                'width' => '100%',
            );
        ...
        private static function get_icon_fields( $in_fields ) {
            ...
            $in_fields[] = array(
                ...
                'options' => array(
                    ...
                    'prem_1' => esc_html__( 'Font icon (Premium)', 'catalog-mode-pricing-enquiry-forms-promotions' ),
                    'prem_2' => esc_html__( 'Image icon (Premium)', 'catalog-mode-pricing-enquiry-forms-promotions' ),
                ),
                'width' => '100%',
            );
