...
if ( !class_exists( 'WModes_Admin_Settings_Styles_Price_Table_Settings' ) && !defined( 'WMODES_PREMIUM_ADDON' ) ) {

    class WModes_Admin_Settings_Styles_Price_Table_Settings {

        public static function init() {
            
            add_filter( 'wmodes-admin/get-settings-styles-section-panels', array( new self(), 'get_panel' ), 50 );
        }
    ...
    WModes_Admin_Settings_Styles_Price_Table_Settings::init();
}
