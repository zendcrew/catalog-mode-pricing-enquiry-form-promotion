...
if ( !class_exists( 'WModes_Admin_Page' ) ) {
    ...
    class WModes_Admin_Page {
        ...
        public static function init_page() {
            ...
            $version_text = sprintf( esc_html__( 'Lite v%s', 'zcwm-tdm' ), WMODES_VERSION );

            if ( defined( 'WMODES_PREMIUM_ADDON' ) ) {

                $version_text = sprintf( esc_html__( 'Premium v%s', 'zcwm-tdm' ), WMODES_VERSION );
            }
            ...
            $args = array(
                ...
                'display' => array(
                    ...
                    'sub_title' => esc_html__( 'Pricing, Enquiry Forms & Promotions', 'zcwm-tdm' ),
                ...
                'ajax' => array(
                    'save_msg' => esc_html__( 'Done!!', 'zcwm-tdm' ),
                    'save_error_msg' => esc_html__( 'Unable to save your settings', 'zcwm-tdm' ),
                    'reset_msg' => esc_html__( 'Done!!', 'zcwm-tdm' ),
                    'reset_error_msg' => esc_html__( 'Unable to reset reset your settings', 'zcwm-tdm' ),
                    'nonce_error_msg' => esc_html__( 'invalid nonce', 'zcwm-tdm' ),
                ),
                'menu' => array(
                    'enable' => true,
                    'title' => esc_html__( 'Catalog Mode - Pricing, Enquiry Forms & Promotions', 'zcwm-tdm' ),
                    'page_title' => esc_html__( 'Catalog Mode - Pricing, Enquiry Forms & Promotions', 'zcwm-tdm' ),
                ...
                'import_export' => array(
                    'enable' => true,
                    'min_height' => '565px',
                    'title' => esc_html__( 'Import / Export', 'zcwm-tdm' ),
                    'import' => array(
                        'title' => esc_html__( 'Import Settings', 'zcwm-tdm' ),
                        'desc' => esc_html__( 'Here you can import new settings. Simply paste the settings url or data on the field below.', 'zcwm-tdm' ),
                        'url_button_text' => esc_html__( 'Import from url', 'zcwm-tdm' ),
                        'url_textbox_desc' => esc_html__( "Paste the url to another site's settings below and click the 'Import Now' button.", 'zcwm-tdm' ),
                        'url_textbox_hint' => esc_html__( "Paste the url to another site's settings here...", 'zcwm-tdm' ),
                        'data_button_text' => esc_html__( 'Import Data', 'zcwm-tdm' ),
                        'data_textbox_desc' => esc_html__( "Paste your backup settings below and click the 'Import Now' button.", 'zcwm-tdm' ),
                        'data_textbox_hint' => esc_html__( 'Paste your backup settings here...', 'zcwm-tdm' ),
                        'import_button_text' => esc_html__( 'Import Now', 'zcwm-tdm' ),
                        'warn_text' => esc_html__( 'Warning! This will override all existing settings. proceed with caution!', 'zcwm-tdm' ),
                    ),
                    'export' => array(
                        'title' => esc_html__( 'Export Settings', 'zcwm-tdm' ),
                        'desc' => esc_html__( 'Here you can backup your current settings. You can later use it to restore your settings.', 'zcwm-tdm' ),
                        'download_button_text' => esc_html__( 'Download Data', 'zcwm-tdm' ),
                        'url_button_text' => esc_html__( 'Export url', 'zcwm-tdm' ),
                        'url_textbox_desc' => esc_html__( 'Copy the url below, use it to transfer the settings from this site.', 'zcwm-tdm' ),
                        'data_button_text' => esc_html__( 'Export Data', 'zcwm-tdm' ),
                        'data_textbox_desc' => esc_html__( 'Copy the data below, use it as your backup.', 'zcwm-tdm' ),
                    ),
                ),
                'header_buttons' => array(
                    'reset_all_text' => esc_html__( 'Reset All', 'zcwm-tdm' ),
                    'reset_section_text' => esc_html__( 'Reset Section', 'zcwm-tdm' ),
                    'save_section_text' => esc_html__( 'Save Section', 'zcwm-tdm' ),
                ),
        ...
        public static function config_all_sections( $in_sections ) {
            ...
            $in_sections[] = array(
                'title' => esc_html__( 'Products Pricing', 'zcwm-tdm' ),
                'id' => 'product_prices',
                'group' => 2,
            );
            ...
            $in_sections[] = array(
                'title' => esc_html__( 'Products Settings', 'zcwm-tdm' ),
                'id' => 'product_options',
                'group' => 3,
            );

            $in_sections[] = array(
                'title' => esc_html__( 'UI Designs', 'zcwm-tdm' ),
                'id' => 'styles',
                'group' => 4,
            );

            $in_sections[] = array(
                'title' => esc_html__( 'Product Badge Designs', 'zcwm-tdm' ),
            ...
            $in_sections[] = array(
                'title' => esc_html__( 'Countdown Designs', 'zcwm-tdm' ),
            ...
            $in_sections[] = array(
                'title' => esc_html__( 'Other UI Designs', 'zcwm-tdm' ),
                'id' => 'styles_settings',
                'group' => 6,
                'subsection' => true
            );
            ...
            $in_sections[] = array(
                'title' => esc_html__( 'General Settings', 'zcwm-tdm' ),
                'id' => 'settings',
                'group' => 7,
            );
        ...
        public static function get_plugin_links( $links ) {
            ...
            if ( defined( 'WMODES_PREMIUM_ADDON' ) ) {
                ...
                $add_on_text = esc_html__( 'WooCommerce Catalog Mode - Premium (Add-On)', 'zcwm-tdm' );

                $required_text = sprintf( esc_html__( 'Required by %s', 'zcwm-tdm' ), $add_on_text );
            ...
            $doc_link = '<a href="' . esc_url( 'https://zencrew.freshdesk.com/support/solutions/51000121630' ) . '">' . esc_html__( 'Documentation', 'zcwm-tdm' ) . '</a>';

            array_unshift( $links, $doc_link );

            $settings_url = admin_url( 'admin.php?page=wmodes-settings' );

            $settings_link = '<a href="' . esc_url( $settings_url ) . '">' . esc_html__( 'Settings', 'zcwm-tdm' ) . '</a>';
        ...
        public static function get_premium_messages( $message_id = '' ) {
            ...
            $premium_url = "#";
            $message = esc_html__( 'This feature is available on premium version', 'zcwm-tdm' );
            $link_text = esc_html__( 'Premium Feature', 'zcwm-tdm' );
        ...
        private static function get_page_links() {
            ...
            $page_links = array(
                array(
                    ...
                    'title' => esc_html__( 'Documentation', 'zcwm-tdm' ),
            ...
            if ( defined( 'WMODES_PREMIUM_ADDON' ) ) {
                ...
                $page_links[] = array(
                    'id' => 'wmds_help',
                    'title' => esc_html__( 'Help', 'zcwm-tdm' ),
                ...
                $page_links[] = array(
                    'id' => 'wmds_get_premium',
                    'title' => esc_html__( 'Premium Version', 'zcwm-tdm' ),
        ...
        private static function get_social_links() {
            ...
            return array(
                array(
                    'id' => 'wmds_facebook',
                    'title' => esc_html__( 'Facebook', 'zcwm-tdm' ),
                    'icon' => 'fa fa-facebook',
                ...
                array(
                    'id' => 'wmds_linkedin',
                    'title' => esc_html__( 'LinkedIn', 'zcwm-tdm' ),
                    'icon' => 'fa fa-linkedin',
                ...
                array(
                    ...
                    'title' => esc_html__( 'Stack Overflow', 'zcwm-tdm' ),
                ...
                array(
                    'id' => 'wmds_instagram',
                    'title' => esc_html__( 'Instagram', 'zcwm-tdm' ),
        ...
        private static function get_section_titles() {
            ...
            $section_titles[ 1 ] = esc_html__( 'Catalog Modes', 'zcwm-tdm' );
            $section_titles[ 2 ] = esc_html__( 'Products Pricing', 'zcwm-tdm' );
            $section_titles[ 3 ] = esc_html__( 'Products Settings', 'zcwm-tdm' );
            $section_titles[ 4 ] = esc_html__( 'Product Badge Designs', 'zcwm-tdm' );
            $section_titles[ 5 ] = esc_html__( 'Product Badge Designs', 'zcwm-tdm' );
            $section_titles[ 6 ] = esc_html__( 'Countdown Designs', 'zcwm-tdm' );
            $section_titles[ 7 ] = esc_html__( 'Other UI Designs', 'zcwm-tdm' );
            $section_titles[ 8 ] = esc_html__( 'General Settings', 'zcwm-tdm' );
            $section_titles[ 9 ] = esc_html__( 'Import / Export', 'zcwm-tdm' );
